...
import virtualAccount from '../services/virtualAccount'

const FormVirtualAccountForm = ({  }) => {
  ...
  const kirim = (data) => {
    ...
    .then(({ data: { data } }) => {
      navigate(`/virtualaccount/confirmation`, { state: data })
    })
    .catch((error) => {
...
export default FormVirtualAccountForm
